...
export default function Home() {
  ...
  return <><SiteHeader /><main className="landing-shell"><Image className="botanical botanical-right" src="/olive-branch.png" alt="" width={1024} height={1536} priority /><Image className="botanical botanical-left-hero" src="/olive-branch.png" alt="" width={1024} height={1536} /><Image className="botanical botanical-left" src="/olive-branch.png" alt="" width={1024} height={1536} /><aside className="side-notes" aria-label="Open recipe principles"><p>Recipes<br />belong<br />to<br />everyone</p><i /><p>Open<br />ingredients,<br />brighter<br />tomorrows</p><i /></aside><section className="hero-copy"><p className="hero-note">An open recipe commons</p><h1 className="font-serif">Contribute a Recipe</h1><p>Help build an open recipe dataset.</p></section><ContributionForm /><section className="open-actions"><Link className="utility-link" href="/recipes"><span className="link-icon"><BookIcon /></span><span>Browse all recipes</span><ArrowIcon /></Link><a className="utility-link" href="/api/recipes?download=1"><span className="link-icon"><DownloadIcon /></span><span>Download dataset</span><ArrowIcon /></a><a className="utility-link" href={github} target="_blank" rel="noreferrer"><span className="link-icon"><GitHubIcon /></span><span>GitHub</span><ArrowIcon /></a></section><p className="open-promise"><span>✳</span> Built in public. Free to browse, download, and improve.</p></main></>;
}
